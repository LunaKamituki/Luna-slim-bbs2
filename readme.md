神月瑠奈(YB民)改造インスタンス(BBS only)　データを傍受可能にする等の改造は一切していません。動画部分のやxmlファイルを削除しました。Pythonは改変していません。<br>
ASGIで動く  
...
<a href="https://render.com/deploy?repo=https://github.com/LunaKamituki/Yuki-Youtube-slim-Luna">
